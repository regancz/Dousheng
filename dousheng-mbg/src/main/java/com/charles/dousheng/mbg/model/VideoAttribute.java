...
public class VideoAttribute implements Serializable {
    ...
    private Long videoAttributeCategoryId;
    ...
    public Long getVideoAttributeCategoryId() {
        return videoAttributeCategoryId;
    }

    public void setVideoAttributeCategoryId(Long videoAttributeCategoryId) {
        this.videoAttributeCategoryId = videoAttributeCategoryId;
    }
    ...
    public String toString() {
        ...
        sb.append(", videoAttributeCategoryId=").append(videoAttributeCategoryId);
